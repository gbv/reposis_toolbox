...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mods="http://www.loc.gov/mods/v3"
  ...
  <xsl:template match="rdf:Description">
    <mods:mods>
      <mods:classification authorityURI="http://openagrar.bmelv-forschung.de/classifications/status" valueURI="http://openagrar.bmelv-forschung.de/classifications/status#published" displayLabel="status"/>
  ...
  <xsl:template match="rdf:type">
    <xsl:if test="./@rdf:resource='http://purl.org/ontology/bibo/Periodical'">
        <mods:genre xmlns:mcr="http://www.mycore.org/" authorityURI="http://openagrar.bmelv-forschung.de/classifications/genres" type="intern" valueURI="http://openagrar.bmelv-forschung.de/classifications/genres#journal"/>
      </xsl:if>
      <xsl:if test="./@rdf:resource='http://purl.org/ontology/bibo/Series'">
        <mods:genre xmlns:mcr="http://www.mycore.org/" authorityURI="http://openagrar.bmelv-forschung.de/classifications/genres" type="intern" valueURI="http://openagrar.bmelv-forschung.de/classifications/genres#series"/>
      </xsl:if>
  </xsl:template>
</xsl:stylesheet>
