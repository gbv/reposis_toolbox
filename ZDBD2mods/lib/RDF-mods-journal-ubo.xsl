...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mods="http://www.loc.gov/mods/v3"
  ...
  <xsl:include href="RDF-mods-journal-ubo.lib.xsl"/> 
  ...
  <xsl:template match="/rdf:RDF">
    <mycoreobject>
      ...
      <service>
        <servstates class="MCRMetaClassification"><servflag type="status" inherited="0" form="plain">confirmed</servflag></servstates>
      </service>
    </mycoreobject>
  </xsl:template>
